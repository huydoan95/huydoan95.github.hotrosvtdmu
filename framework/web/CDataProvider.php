...
abstract class CDataProvider extends CComponent implements IDataProvider
{
	...
	/**
	 * Returns loainguoidung that uniquely identifies the data provider.
	 * @return int loainguoidung that uniquely identifies the data provider among all data providers.
	 */
