...
class CWebUser extends CApplicationComponent implements IWebUser
{
	...
	{
		$id=$identity->getId();
		//$loainguoidung=$identity->getLoainguoidung();
	...
	{
		return $this->getState('__loainguoidung');
	}*/

	/**
	 * @param mixed $value the unique identifier for the user. If null, it means the user is a guest.
	 */
	/*public function setLoainguoidung($value)
	{
		$this->setState('__loainguoidung',$value);
	}*/
	/**
	...
	public function loginRequired()
	{
		...
		if(($url=$this->loginUrl)!==null)
		{
			...
			throw new CHttpException(403,Yii::t('yii','Yêu c?u ??ng nh?p'));
	}
	...
	protected function changeIdentity($id,$name,$states)
	{
		...
		$this->setId($id);
		//$this->setLoainguoidung($loainguoidung);
		$this->setName($name);
